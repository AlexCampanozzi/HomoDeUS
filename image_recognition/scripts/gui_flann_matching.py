...
#Custom msg imports
from image_recognition.msg import valueMatrix

pub = rospy.Publisher('image_recognition/flann_matching_gui', valueMatrix, queue_size=10)

class MyWindow(QtGui.QMainWindow):
	def __init__(self):
		super(MyWindow, self).__init__()
		self.rospack = rospkg.RosPack()
		path = self.rospack.get_path('image_recognition')
