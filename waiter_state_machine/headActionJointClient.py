#! /usr/bin/env python
# this file is not usefull as the testing is in progress : Kate
import os
import rospy
import roslib
import actionlib
...
class HeadActionClient:
    ...
    def __init__(self):
        ...
        rospy.init_node('headActionJoint', anonymous=False)
        self.client = actionlib.SimpleActionClient(
            "/head_controller/follow_joint_trajectory", control_msgs.msg.JointTrajectory)
    ...
    def GotoPosition(self, x, y):
        ...
        """
        goal = control_msgs.msg.FollowJointTrajectory()
